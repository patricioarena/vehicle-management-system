...
public enum StateVehicle {
  NEW(
      "Unused, in perfect mechanical and aesthetic condition. It has no wear and does not require"
          + " reconditioning."),
  CLEAN(
      "Some normal wear, but no major mechanical or cosmetic problems. May require limited"
          + " reconditioning."),
